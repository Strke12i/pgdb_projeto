...
export class Default1697760415483 implements MigrationInterface {
    name = 'Default1697760415483'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`pessoa_aluno\` (\`matricula\` int NOT NULL, \`nomeAluno\` varchar(255) NOT NULL, \`cpf\` varchar(255) NOT NULL, \`dataNascimento\` date NOT NULL, \`email\` varchar(255) NOT NULL, \`genero\` varchar(255) NOT NULL, PRIMARY KEY (\`matricula\`)) ENGINE=InnoDB`);
